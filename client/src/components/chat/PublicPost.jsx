        ...
        <div className="flex gap-2 items-center">
             {isAuthor && onDelete && (
                <button 
                  ...
                  className="p-1.5 text-zinc-600 hover:text-red-400 hover:bg-red-500/10 rounded-full transition-colors opacity-0 group-hover:opacity-100"
                  title="Delete Post"
                >
                    <Trash2 size={16} />
                </button>
      ...
      <div className="flex items-center justify-between pt-3 border-t border-white/5">
        <div className="flex gap-4">
          <button 
            ...
            className={`flex items-center gap-1.5 text-xs transition-colors ${isLiked ? 'text-pink-500' : 'text-zinc-400 hover:text-pink-400'}`}
          >
